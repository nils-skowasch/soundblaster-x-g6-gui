...
class Model:
    ...
    def __handle_voice_clarity_noise_reduction_enabled(self) -> None:
        self.__view.set_voice_clarity_noise_reduction_checkbox_enabled(self.__voice_clarity_noise_reduction_available)
        self.__view.set_voice_clarity_noise_reduction_slider_enabled(
            self.__voice_clarity_noise_reduction_available and self.__voice_clarity_noise_reduction_enabled)
    ...
    def __handle_voice_clarity_acoustic_echo_cancellation_enabled(self) -> None:
        self.__view.set_voice_clarity_acoustic_echo_cancellation_enabled(
            self.__voice_clarity_acoustic_echo_cancellation_available)
    ...
    def __handle_voice_clarity_smart_volume_enabled(self) -> None:
        self.__view.set_voice_clarity_smart_volume_enabled(self.__voice_clarity_smart_volume_available)
    ...
    def __handle_voice_clarity_mic_equalizer_enabled(self) -> None:
        self.__view.set_voice_clarity_mic_equalizer_checkbox_enabled(self.__voice_clarity_mic_equalizer_available)
        self.__view.set_voice_clarity_mic_equalizer_preset_enabled(
            self.__voice_clarity_mic_equalizer_available and self.__voice_clarity_mic_equalizer_enabled
        )
...
class View:
    ...
    def create(self, notebook: wx.Notebook) -> wx.Panel:
        ...
        self.__sld_noise_reduction.Bind(wx.EVT_SCROLL_CHANGED,
                                        lambda event: self.__controller.on_change_voice_clarity_noise_reduction_level(
                                            event))
        ...
        self.__chk_echo_cancellation.Bind(wx.EVT_CHECKBOX,
                                          lambda
                                              event: self.__controller.on_toggle_voice_clarity_acoustic_echo_cancellation(
                                              event))
        ...
        self.__chk_smart_volume.Bind(wx.EVT_CHECKBOX,
                                     lambda event: self.__controller.on_toggle_voice_clarity_smart_volume(event))
        ...
        self.__chk_mic_eq.Bind(wx.EVT_CHECKBOX,
                               lambda event: self.__controller.on_toggle_voice_clarity_mic_equalizer(event))
        ...
        self.__cmb_mic_eq_preset.Bind(wx.EVT_COMBOBOX,
                                      lambda event: self.__controller.on_change_voice_clarity_mic_equalizer_preset(
                                          event))
...
class Controller:
    ...
    def __apply_api_model(self):
        # load recording data from api model
        if self.__g6_api is None:
            return
        recording = self.__g6_api.get_model().get_recording()

        # update ui model
        ## microphone
        self.__model.set_mic_recording_volume(recording.get_mic_recording_volume(channel=Channel.CHANNEL_1))

        self.__model.set_mic_boost(recording.get_mic_boost())

        self.__model.set_mic_monitoring_enabled(not recording.get_mic_monitoring_mute())
        self.__model.set_mic_monitoring_volume(recording.get_mic_monitoring_volume(channel=Channel.CHANNEL_1))

        ## voice clarity
        self.__model.set_voice_clarity_noise_reduction_enabled(recording.get_voice_clarity_noise_reduction_enabled())
        self.__model.set_voice_clarity_noise_reduction_level(recording.get_voice_clarity_noise_reduction_level())

        self.__model.set_voice_clarity_acoustic_echo_cancellation_enabled(
            recording.get_voice_clarity_acoustic_echo_cancellation_enabled())

        self.__model.set_voice_clarity_smart_volume_enabled(recording.get_voice_clarity_smart_volume_enabled())

        self.__model.set_voice_clarity_mic_equalizer_enabled(recording.get_voice_clarity_mic_equalizer_enabled())
        self.__model.set_voice_clarity_mic_equalizer_preset(recording.get_voice_clarity_mic_equalizer_preset())
